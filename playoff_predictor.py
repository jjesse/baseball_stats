...
def get_fallback_team_strength():
    ...
    return {
        # AL East
        'New York Yankees': {'wins': 48, 'losses': 47, 'win_pct': 0.505, 'projected_wins': 81.8, 'strength_score': 0.51, 'games_remaining': 67, 'division': 'al_east'},
        'Tampa Bay Rays': {'wins': 47, 'losses': 48, 'win_pct': 0.495, 'projected_wins': 80.2, 'strength_score': 0.49, 'games_remaining': 67, 'division': 'al_east'},
        'Toronto Blue Jays': {'wins': 45, 'losses': 50, 'win_pct': 0.474, 'projected_wins': 76.8, 'strength_score': 0.47, 'games_remaining': 67, 'division': 'al_east'},
        'Boston Red Sox': {'wins': 41, 'losses': 54, 'win_pct': 0.432, 'projected_wins': 69.9, 'strength_score': 0.43, 'games_remaining': 67, 'division': 'al_east'},
        'Baltimore Orioles': {'wins': 38, 'losses': 57, 'win_pct': 0.400, 'projected_wins': 64.8, 'strength_score': 0.40, 'games_remaining': 67, 'division': 'al_east'},
        
        # AL Central  
        'Detroit Tigers': {'wins': 53, 'losses': 42, 'win_pct': 0.558, 'projected_wins': 90.4, 'strength_score': 0.67, 'games_remaining': 67, 'division': 'al_central'},
        'Cleveland Guardians': {'wins': 52, 'losses': 43, 'win_pct': 0.547, 'projected_wins': 88.6, 'strength_score': 0.65, 'games_remaining': 67, 'division': 'al_central'},
        'Minnesota Twins': {'wins': 44, 'losses': 51, 'win_pct': 0.463, 'projected_wins': 75.0, 'strength_score': 0.46, 'games_remaining': 67, 'division': 'al_central'},
        'Kansas City Royals': {'wins': 39, 'losses': 56, 'win_pct': 0.411, 'projected_wins': 66.6, 'strength_score': 0.41, 'games_remaining': 67, 'division': 'al_central'},
        'Chicago White Sox': {'wins': 25, 'losses': 70, 'win_pct': 0.263, 'projected_wins': 42.6, 'strength_score': 0.26, 'games_remaining': 67, 'division': 'al_central'},
        
        # AL West
        'Houston Astros': {'wins': 51, 'losses': 44, 'win_pct': 0.537, 'projected_wins': 86.9, 'strength_score': 0.63, 'games_remaining': 67, 'division': 'al_west'},
        'Seattle Mariners': {'wins': 47, 'losses': 48, 'win_pct': 0.495, 'projected_wins': 80.2, 'strength_score': 0.49, 'games_remaining': 67, 'division': 'al_west'},
        'Texas Rangers': {'wins': 42, 'losses': 53, 'win_pct': 0.442, 'projected_wins': 71.6, 'strength_score': 0.44, 'games_remaining': 67, 'division': 'al_west'},
        'Los Angeles Angels': {'wins': 38, 'losses': 57, 'win_pct': 0.400, 'projected_wins': 64.8, 'strength_score': 0.40, 'games_remaining': 67, 'division': 'al_west'},
        'Oakland Athletics': {'wins': 37, 'losses': 58, 'win_pct': 0.389, 'projected_wins': 63.0, 'strength_score': 0.39, 'games_remaining': 67, 'division': 'al_west'},
        
        # NL East
        'Philadelphia Phillies': {'wins': 54, 'losses': 41, 'win_pct': 0.568, 'projected_wins': 92.0, 'strength_score': 0.69, 'games_remaining': 67, 'division': 'nl_east'},
        'Atlanta Braves': {'wins': 49, 'losses': 46, 'win_pct': 0.516, 'projected_wins': 83.6, 'strength_score': 0.54, 'games_remaining': 67, 'division': 'nl_east'},
        'New York Mets': {'wins': 45, 'losses': 50, 'win_pct': 0.474, 'projected_wins': 76.8, 'strength_score': 0.47, 'games_remaining': 67, 'division': 'nl_east'},
        'Washington Nationals': {'wins': 40, 'losses': 55, 'win_pct': 0.421, 'projected_wins': 68.2, 'strength_score': 0.42, 'games_remaining': 67, 'division': 'nl_east'},
        'Miami Marlins': {'wins': 34, 'losses': 61, 'win_pct': 0.358, 'projected_wins': 58.0, 'strength_score': 0.36, 'games_remaining': 67, 'division': 'nl_east'},
        
        # NL Central
        'Milwaukee Brewers': {'wins': 53, 'losses': 42, 'win_pct': 0.558, 'projected_wins': 90.4, 'strength_score': 0.67, 'games_remaining': 67, 'division': 'nl_central'},
        'Chicago Cubs': {'wins': 47, 'losses': 48, 'win_pct': 0.495, 'projected_wins': 80.2, 'strength_score': 0.49, 'games_remaining': 67, 'division': 'nl_central'},
        'St. Louis Cardinals': {'wins': 45, 'losses': 50, 'win_pct': 0.474, 'projected_wins': 76.8, 'strength_score': 0.47, 'games_remaining': 67, 'division': 'nl_central'},
        'Cincinnati Reds': {'wins': 42, 'losses': 53, 'win_pct': 0.442, 'projected_wins': 71.6, 'strength_score': 0.44, 'games_remaining': 67, 'division': 'nl_central'},
        'Pittsburgh Pirates': {'wins': 41, 'losses': 54, 'win_pct': 0.432, 'projected_wins': 69.9, 'strength_score': 0.43, 'games_remaining': 67, 'division': 'nl_central'},
        
        # NL West
        'Los Angeles Dodgers': {'wins': 58, 'losses': 37, 'win_pct': 0.611, 'projected_wins': 98.9, 'strength_score': 0.76, 'games_remaining': 67, 'division': 'nl_west'},
        'San Diego Padres': {'wins': 48, 'losses': 47, 'win_pct': 0.505, 'projected_wins': 81.8, 'strength_score': 0.51, 'games_remaining': 67, 'division': 'nl_west'},
        'Arizona Diamondbacks': {'wins': 47, 'losses': 48, 'win_pct': 0.495, 'projected_wins': 80.2, 'strength_score': 0.49, 'games_remaining': 67, 'division': 'nl_west'},
        'San Francisco Giants': {'wins': 44, 'losses': 51, 'win_pct': 0.463, 'projected_wins': 75.0, 'strength_score': 0.46, 'games_remaining': 67, 'division': 'nl_west'},
        'Colorado Rockies': {'wins': 35, 'losses': 60, 'win_pct': 0.368, 'projected_wins': 59.6, 'strength_score': 0.37, 'games_remaining': 67, 'division': 'nl_west'}
    }
    ...
    for division, teams in divisions.items():
        ...
        for team, stats in teams:
            if total_strength > 0:
                ...
                if 'al_' in division:
                    playoff_scenarios['al_division_winners'][team] = round(division_prob, 1)
                else:
                    playoff_scenarios['nl_division_winners'][team] = round(division_prob, 1)
    
    # Calculate Wild Card probabilities
    al_teams = [(team, stats) for team, stats in team_strength.items() 
                if stats['division'].startswith('al_')]
    nl_teams = [(team, stats) for team, stats in team_strength.items() 
...
def create_playoff_visualizations(playoff_scenarios, team_strength):
    ...
    try:
        ...
        fig.suptitle('2025 MLB Playoff Probability Tracker', fontsize=16, fontweight='bold')
        
        # AL Division Winners
        al_div_teams = list(playoff_scenarios['al_division_winners'].keys())[:8]
        al_div_probs = [playoff_scenarios['al_division_winners'][team] for team in al_div_teams]
        ...
        nl_div_probs = [playoff_scenarios['nl_division_winners'][team] for team in nl_div_teams]
        ...
        plt.tight_layout()
        plt.savefig(f"{output_path}/playoff_probabilities_chart.png", dpi=150, bbox_inches='tight')
        plt.close()
        ...
        plt.tight_layout()
        plt.savefig(f"{output_path}/world_series_odds_chart.png", dpi=150, bbox_inches='tight')
        plt.close()
...
def generate_playoff_summary():
    ...
    ws_favorites = sorted(playoff_scenarios['world_series_odds'].items(), 
    ...
    for division in divisions:
        div_teams = [(team, stats) for team, stats in team_strength.items() 
    ...
    # Wild Card battles
    al_wc_contenders = sorted(playoff_scenarios['al_wild_card'].items(), 
                              key=lambda x: x[1], reverse=True)[:6]
    nl_wc_contenders = sorted(playoff_scenarios['nl_wild_card'].items(), 
                              key=lambda x: x[1], reverse=True)[:6]
    
    insights['wild_card_battles'] = {
        'al_contenders': [{'team': team, 'probability': prob} for team, prob in al_wc_contenders],
        'nl_contenders': [{'team': team, 'probability': prob} for team, prob in nl_wc_contenders]
    }
